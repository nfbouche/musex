...
# read version from musex/version.py
musex_dir = os.path.join(os.path.dirname(__file__), '..', 'musex')
pkgmeta = {}

with open(os.path.join(musex_dir, 'version.py')) as f:
    code = compile(f.read(), 'version.py', 'exec')
    exec(code, pkgmeta)

if os.path.isfile(os.path.join(musex_dir, '_githash.py')):
    with open(os.path.join(musex_dir, '_githash.py')) as f:
